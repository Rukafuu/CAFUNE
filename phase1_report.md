...
O motor **CAFUNE** (*Composite Architecture for Fast Universal Noise-reduction Engine*) concluiu sua primeira fase de desenvolvimento. Conseguimos integrar Python e Julia em um pipeline de **Discrete Masked Diffusion** (LLaDA-style) funcional.
